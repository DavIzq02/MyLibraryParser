...
public final class UmlAnnotation extends UmlClassifier {

    public UmlAnnotation(String name, UmlNamespace namespace, UmlVisibility visibility, List<String> templateParameters,
            Set<UmlModifier> modifiers, List<UmlProperty> properties, List<UmlOperation> operations,

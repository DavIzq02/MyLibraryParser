...
public final class UmlClass extends UmlClassifier {
            public UmlClass( String name, UmlNamespace namespace, UmlVisibility visibility, List<String> templateParameters, Set<UmlModifier> modifiers, List<UmlProperty> properties, List<UmlOperation> operations, Optional<String> stereotype, Optional<String> note) {

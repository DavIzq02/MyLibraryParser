...
public record UmlOperation(String name, UmlVisibility visibility, UmlType returnType, List<UmlParameter> parameters,
        Set<UmlModifier> modifiers, Optional<String> stereotype, boolean constructor) {
    ...
    public boolean isDefault() { return modifiers.contains(UmlModifier.DEFAULT); }
}